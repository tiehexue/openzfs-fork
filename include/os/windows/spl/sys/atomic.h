...
{
	return (InterlockedExchangeAdd64((volatile LONG64 *)target,
	    delta) + delta);
}
...
{
	return (InterlockedCompareExchange((volatile LONG *)_target, _new,
	    _cmp));
}
...
{
	return (InterlockedCompareExchange64((volatile LONG64 *)_target,
	    _new, _cmp));
}
